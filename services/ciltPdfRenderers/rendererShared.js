...
const V2_RENDERER_STYLES = `
  ...
  .prg-legend-swatch--good {
    border: 1px solid #86efac;
    background: #dcfce7;
  }
  .prg-legend-swatch--need {
    border: 1px solid #fde68a;
    background: #fef3c7;
  }
  .prg-legend-swatch--reject {
  ...
  .pkg-watermark {
    ...
    font-style: italic;
    font-weight: 700;
    color: rgba(173, 29, 44, 0.62);
    letter-spacing: 1px;
    white-space: nowrap;
    border: 3px solid rgba(173, 29, 44, 0.6);
    border-radius: 6px;
    padding: 4px 16px;
    z-index: 2;
    pointer-events: none;
